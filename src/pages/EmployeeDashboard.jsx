  ...
  useEffect(() => {
    const fetchEmployeeData = async () => {
      try {
        ...
        // Now fetch leave data from backend
        if (employeeId) {
          ...
          const totalLeaves = employeeInfo.totalLeaves || 25; // Use backend value or default
          ...
          const enhancedEmployee = {
            ...
            pendingLeaves: leaveData.filter(leave => leave.status?.toLowerCase() === 'pending').length,
          };

          console.log("Enhanced employee data with leave calculations:", enhancedEmployee);
