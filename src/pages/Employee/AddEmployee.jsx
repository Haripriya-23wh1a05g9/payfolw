...
export default function AddEmployee() {
  ...
  const validatePage3 = () => {
    // Position and totalLeaves are always required
    if (!form.position.trim() || !form.totalLeaves.trim()) return false;
  ...
  const pages = [
    ...
    <div>
      ...
      {/* Position, Manager and Total Leaves Fields */}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          {currentUserRole === "HR" ? (
            ...
            <div style={{
              ...
              {currentUser?.username} (You) - Auto-assigned
            </div>
          ) : (
            <div style={{
              ...inputStyle,
