...
const RegisterPage = () => {
  ...
  // For demo, admin self-registers, HR/Manager must be created by admin (simulate createdBy=1)
    ...
    <div style={{ minHeight: "100vh", background: "#f8fafc" }}>
      ...
      <div className="form-container" style={{
        ...
        <form onSubmit={handleSubmit} aria-label="Register form" style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <select id="role" name="role" value={form.role} onChange={handleChange} style={{ marginBottom: 8, width: "100%", padding: 8, borderRadius: 6, border: "1px solid #e2e8f0" }} aria-label="Role">
            <option value="admin">Admin</option>
            <option value="hr">HR</option>
            <option value="manager">Manager</option>
          </select>
          <label htmlFor="username" style={{ fontWeight: 500, marginBottom: 4 }}>Full Name</label>
          <input id="username" name="username" type="text" placeholder="Full Name" required value={form.username} onChange={handleChange} style={{ marginBottom: 8, width: "100%", padding: 12, borderRadius: 6, border: "1px solid #e2e8f0" }} aria-required="true" aria-label="Full Name" />
          <label htmlFor="email" style={{ fontWeight: 500, marginBottom: 4 }}>Email</label>
          <input id="email" name="email" type="email" placeholder="Email" required value={form.email} onChange={handleChange} style={{ marginBottom: 8, width: "100%", padding: 12, borderRadius: 6, border: "1px solid #e2e8f0" }} aria-required="true" aria-label="Email" />
          <label htmlFor="password" style={{ fontWeight: 500, marginBottom: 4 }}>Password</label>
          <input id="password" name="password" type="password" placeholder="Password" required value={form.password} onChange={handleChange} style={{ marginBottom: 16, width: "100%", padding: 12, borderRadius: 6, border: "1px solid #e2e8f0" }} aria-required="true" aria-label="Password" />
