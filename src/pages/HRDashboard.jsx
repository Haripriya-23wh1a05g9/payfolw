...
const HRNavigation = React.memo(({ user, currentTime }) => (
  <nav
    style={{
      display: "flex",
      alignItems: "center",
...
export default function HRDashboard() {
  ...
  return (
    ...
    >
      <HRNavigation user={user} currentTime={currentTime} />
            ...
            >
              ...
              >
                ...
                <div style={{ marginBottom: 28 }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                    <div style={{ padding: 12, background: palette.bg, borderRadius: 8 }}>
                      <strong style={{ color: palette.accent }}>Position:</strong>
                      <p style={{ margin: 0, marginTop: 4, color: "#1a1a1a", fontWeight: 600 }}>{selectedEmployee.position || selectedEmployee.jobTitle || "N/A"}</p>
                    </div>
                    <div style={{ padding: 12, background: palette.bg, borderRadius: 8 }}>
                    ...
                    <div style={{ padding: 12, background: palette.bg, borderRadius: 8 }}>
                      <strong style={{ color: palette.accent }}>Salary:</strong>
                      <p style={{ margin: 0, marginTop: 4, color: "#1a1a1a", fontWeight: 600 }}>
                        {selectedEmployee.salary ? `₹${Number(selectedEmployee.salary).toLocaleString('en-IN')}` : "N/A"}
                      </p>
                    </div>
                    <div style={{ padding: 12, background: palette.bg, borderRadius: 8 }}>
